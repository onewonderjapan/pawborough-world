...
const files=['world/instances.json','world/segment.json','world/segment-spec.json','world/asset-catalog.json','world/cameras.json','world/render-setup.json','world/review-manifest.json','world/street-kit.glb','world/street-reviewed.glb'];
...
console.log(`Strict review build copied ${files.length} required files; errors are not suppressed.`);
