...
export const GROUND_NODE_RE = /^street-kit__(quiet-gray-asphalt|paving-frontage|worn-stone)$|^laneb__floor$|^sctail__(quiet-gray-asphalt|worn-stone)$|^temple-ground__(paving-frontage|worn-stone)$/;
