...
export default defineConfig({cacheDir:'.cache/vite',server:{open:false,watch:{usePolling:true,interval:2000}},preview:{open:false},build:{rollupOptions:{input:{index:resolve(import.meta.dirname,'index.html'),temple:resolve(import.meta.dirname,'temple.html'),'temple-entry':resolve(import.meta.dirname,'temple-entry.html'),dadian:resolve(import.meta.dirname,'dadian.html')}}},plugins:[{name:'lead-review-evidence',configureServer:evidence,configurePreviewServer:evidence}]});
